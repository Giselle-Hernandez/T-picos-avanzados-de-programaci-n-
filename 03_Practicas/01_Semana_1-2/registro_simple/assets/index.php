    ...
    <div class="contenedor"> <!-- sirve para englobar o agrupar todo el formulario. Class contenedor es una clase del css-->
        <div class="carta"> <!--es para darle formato de carta al formulario -->
            ...
            <form action="procesar.php" method="POST"> <!--Los datos se envian al archivo de procesar utilizando el metodo POST-->
                ...
                <input type="text" name="nombre" required minlength="3"> <!--tipo de dato que solicita, nombre de lo que pide, los requisitos minimos y una etiqueta que muestra un ejemplo -->

                <label>Correo:</label> <!--Etiqueta que se muestra en el formulario -->
                <input type="email" name="correo" required > <!-- input es un campo de entrada, required hace que el ca,po sea obligatorio-->

                <label>Edad:</label>
                <input type="number" name="edad" required min="15" max="99">

                <label>Contraseña:</label>
                <input type="password" name="contraseña" required minlength="6">

                <label>Confirmar contraseña:</label>
                <input type="password" name="confirm_contraseña" required>
